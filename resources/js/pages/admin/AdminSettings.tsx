...
export function AdminSettings() {
    ...
    const C = dict({
        bm: {
            ...
            hostMusicTitle: 'Benarkan tuan rumah muat naik fail MP3',
            hostMusicDesc: 'Apabila hidup, tuan rumah boleh muat naik fail MP3 sendiri. Apabila mati, muat naik fail MP3 dimatikan — mereka masih boleh tampal pautan YouTube atau pilih daripada pustaka muzik anda.',
        ...
        en: {
            ...
            hostMusicTitle: 'Let hosts upload an MP3 file',
            hostMusicDesc: 'When on, hosts can upload their own MP3 file. When off, MP3 file upload is disabled — they can still paste a YouTube link or pick from your music library.',
        ...
        zh: {
            ...
            hostMusicTitle: '允许主人上传 MP3 文件',
            hostMusicDesc: '开启后，主人可上传自己的 MP3 文件；关闭后，MP3 文件上传被禁用——他们仍可粘贴 YouTube 链接或从您的音乐库中选择。',
