...
const COPY: Record<'bm' | 'en', Copy> = {
    bm: {
        hero: {
            ...
            title: ['Kad Kahwin Digital,', 'Dibuat Dengan Hati'],
            lead: 'Cipta kad jemputan digital yang elegan dalam beberapa minit — lengkap dengan RSVP, aturcara majlis, lokasi Waze, salam kaut, buku ucapan dan susunan meja.',
            ctaPrimary: 'Cipta Kad Percuma',
            ctaSecondary: 'Lihat Templat',
            note: 'Tanpa kad kredit · Siap dalam beberapa minit',
        },
        card: { eyebrow: 'Walimatulurus', save: 'Simpan Tarikh', date: 'Sabtu, 12 Disember 2026', venue: 'Dewan Seri Melati' },
        emotion: {
            eyebrow: 'Lebih Dari Sekadar Kad',
            title: 'Setiap jemputan ialah cara anda menyampaikan rasa',
            sub: 'Di sebalik setiap majlis ada niat yang tulus. Kami bantu anda sampaikan undangan itu dengan cara yang paling menyentuh hati.',
            points: [
                { title: 'Jemput dengan penuh adab', desc: 'Susunan kata dan reka bentuk yang santun, sesuai untuk keluarga dan tetamu kehormat.' },
                { title: 'Biarkan tetamu rasa dekat', desc: 'Animasi lembut, muzik latar dan sentuhan peribadi buat mereka rasa diraikan.' },
                { title: 'Lebih tenang sebelum majlis', desc: 'RSVP, senarai tetamu dan susunan meja terurus di satu tempat — kurang risau, lebih fokus.' },
            ],
        },
        features: {
            eyebrow: 'Semua Dalam Satu Portal',
            title: 'Ciri Utama',
            sub: 'Segala yang anda perlukan untuk menganjur majlis kahwin moden — tanpa berpindah aplikasi.',
            items: [
                { title: 'RSVP Pintar', desc: 'Tetamu sahkan kehadiran dalam satu ketukan.' },
                { title: 'Susunan Meja', desc: 'Auto-agih tempat duduk & susun semula bila-bila masa.' },
                { title: 'Lokasi Waze & Maps', desc: 'Satu ketukan terus ke Waze atau Google Maps.' },
                { title: 'Salam Kaut', desc: 'Terima sumbangan terus ke akaun atau DuitNow QR.' },
                { title: 'Buku Ucapan', desc: 'Doa & ucapan tetamu dipaparkan secara berkelas.' },
                { title: 'Muzik Latar', desc: 'Lagu syahdu mengiringi setiap detik.' },
                { title: 'QR Check-in', desc: 'Daftar masuk tetamu pantas dengan imbasan QR.' },
                { title: 'Templat Beranimasi', desc: 'Reka bentuk hidup dengan animasi menawan.' },
            ],
        },
        how: {
            eyebrow: 'Mudah & Pantas',
            title: 'Cara Ia Berfungsi',
            sub: 'Tiga langkah sahaja daripada idea kepada kad yang tersedia untuk dikongsi.',
            steps: [
                { title: 'Pilih templat', desc: 'Pilih reka bentuk kegemaran anda dan warnakan ikut tema majlis.' },
                { title: 'Isi butiran majlis', desc: 'Masukkan nama, tarikh, lokasi dan aturcara — siap dalam beberapa minit.' },
                { title: 'Kongsi & terima RSVP', desc: 'Hantar pautan kepada tetamu dan pantau kehadiran secara langsung.' },
            ],
        },
        templates: {
            eyebrow: 'Koleksi Templat',
            title: 'Reka bentuk yang hidup, bukan statik',
            sub: 'Floral, tirai sinematik, khat Islamik dan songket tradisi — semua boleh diwarnakan semula ikut citarasa anda.',
            cta: 'Lihat Templat',
        ...
        pricing: {
            eyebrow: 'Harga Telus',
            title: 'Harga Mudah',
            sub: 'Mula percuma. Naik taraf hanya apabila anda perlukan lebih.',
            free: {
                badge: 'Percuma',
                name: 'Pelan Percuma',
                price: 'RM0',
                blurb: 'Sesuai untuk mula membina kad pertama anda.',
                features: ['1 kad kahwin', 'Templat Floral percuma', 'RSVP & buku ucapan', 'Countdown ke hari bahagia'],
                cta: 'Mula Sekarang',
            },
            premium: {
                badge: 'Premium',
                ...
                per: '/ kad',
                tag: 'Paling Popular',
                blurb: 'Untuk majlis yang mahukan pengalaman lengkap.',
                features: ['Semua templat premium', 'Susunan meja + auto-agih', 'QR check-in & Salam Kaut', 'Muzik latar & galeri penuh', 'Tanpa tanda air'],
                cta: 'Naik Taraf',
            },
            secure: 'Pembayaran selamat melalui ToyyibPay (FPX & e-Wallet)',
        },
        footer: {
            tagline: 'Kad kahwin digital Malaysia, dibuat dengan hati.',
            nav: { templates: 'Templat', features: 'Ciri-ciri', pricing: 'Harga' },
