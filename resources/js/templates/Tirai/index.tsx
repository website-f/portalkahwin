...
import { useEffect, useMemo, useRef, useState } from 'react';import type { CSSProperties, ReactNode } from 'react';
 ...
 */
const MOTION = REVEAL_TIMING[TEMPLATE_ART['tirai'].reveal];
...
function TiraiTemplateInner({ data, preview, slots }: TemplateProps) {
    ...
    const rootStyle: CSSProperties = {
        ...
        color: theme.text,
        background: theme.bg,
        backgroundImage: `${groundPattern('diamond', theme.accent, 0.05)}, radial-gradient(120% 60% at 50% 0%, rgba(255,255,255,0.6), rgba(255,255,255,0) 55%)`,
